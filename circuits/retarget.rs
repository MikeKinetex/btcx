...
impl<L: PlonkParameters<D>, const D: usize> BitcoinVerifyWithRetargetCircuit<L, D> for CircuitBuilder<L, D> {
    fn verify_with_retargeting<const UPDATE_HEADERS_COUNT: usize>(
        &mut self,
        prev_block_number: U64Variable,
        prev_header_hash: BlockHashVariable,
    ...
    for VerifyOffchainInputs<UPDATE_HEADERS_COUNT>
{
    fn hint(
        ...
        let next_period_start_header = input_fetcher.get_header_by_height(period_end_block_number + 1);
        let next_threshold = U256::from_little_endian( &next_period_start_header.target().to_le_bytes() );
...
impl<const UPDATE_HEADERS_COUNT: usize> Circuit for VerifyWithRetargetCircuit<UPDATE_HEADERS_COUNT> {
    fn define<L: PlonkParameters<D>, const D: usize>(builder: &mut CircuitBuilder<L, D>) {
        ...
        let (last_header_hash, next_threshold) =
            builder.verify_with_retargeting::<UPDATE_HEADERS_COUNT>(
                prev_block_number,
                prev_header_hash,
                period_start_hash,
                current_threshold
...
mod tests {
    ...
    fn test_verify_with_retargeting_203610_10() {
        ...
        let prev_header_hash = bytes32!("a12e1f2157c6f99469ccdb46ae68577273d3551f6a38d17ab304000000000000");
        let period_start_hash = bytes32!("d09acdf9c9959a1754da9dae916e70bef9f131ad30ef8be2a503000000000000");
        let current_threshold = U256::from_dec_str("8825801199382903987726989797449454220615414953524072026210304").unwrap();
        test_verify_with_retargeting_template::<UPDATE_HEADERS_COUNT>(prev_block_number, prev_header_hash, period_start_hash, current_threshold);
    }
    ...
    fn test_verify_with_retargeting_2015_10() {
        ...
        let prev_header_hash = bytes32!("6397bb6abd4fc521c0d3f6071b5650389f0b4551bc40b4e6b067306900000000");
        let period_start_hash = bytes32!("6fe28c0ab6f1b372c1a6a246ae63f74f931e8365e15a089c68d6190000000000");
        let current_threshold = U256::from_dec_str("26959535291011309493156476344723991336010898738574164086137773096960").unwrap();
        test_verify_with_retargeting_template::<UPDATE_HEADERS_COUNT>(prev_block_number, prev_header_hash, period_start_hash, current_threshold);
    }
    ...
    fn test_verify_with_retargeting_2016_10() {
        ...
        let prev_header_hash = bytes32!("efdd7b6c4ce1dcbb370690558d7a556e431c3011f2546c896a2141a100000000");
        let period_start_hash = bytes32!("efdd7b6c4ce1dcbb370690558d7a556e431c3011f2546c896a2141a100000000");
        let current_threshold = U256::from_dec_str("26959535291011309493156476344723991336010898738574164086137773096960").unwrap();
        test_verify_with_retargeting_template::<UPDATE_HEADERS_COUNT>(prev_block_number, prev_header_hash, period_start_hash, current_threshold);
    }
}